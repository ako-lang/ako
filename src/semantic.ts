...
export function getGrammar () {
    ...
    const ASTBuilder = semantics.addOperation('toAST', {
        ...
        // Conditional
        If: (_, ifCond, ifBlock, __, elifCond, elifBlock, ___, elseBlock) => AkoElement.If.create(ifCond.toAST(), ifBlock.toAST(), elifCond.toAST(), elifBlock.toAST(), elseBlock.toAST()),
